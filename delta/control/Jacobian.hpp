#ifndef CH_NTB_EEDURO_DELTA_JACOBIAN_HPP
#define CH_NTB_EEDURO_DELTA_JACOBIAN_HPP
...
namespace eeduro {
	namespace delta {
		...
		public:
			...
			*/
			virtual void calculate(const eeros::math::Vector3& q, const eeros::math::Vector3& tcp);
...
#endif /* CH_NTB_EEDURO_DELTA_JACOBIAN_HPP */
